...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var t=require("redom"),e=n(require("./Language")),o=n(require("./Utilities"));function n(t){return t&&t.__esModule?t:{default:t}}function c(t,e){var o="undefined"!=typeof Symbol&&t[Symbol.iterator]||t["@@iterator"];if(!o){if(Array.isArray(t)||(o=i(t))||e&&t&&"number"==typeof t.length){o&&(t=o);var n=0,c=function(){};return{s:c,n:function(){return n>=t.length?{done:!0}:{done:!1,value:t[n++]}},e:function(t){throw t},f:c}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var a,r=!0,_=!1;return{s:function(){o=o.call(t)},n:function(){var t=o.next();return r=t.done,t},e:function(t){_=!0,a=t},f:function(){try{r||null==o.return||o.return()}finally{if(_)throw a}}}}function i(t,e){if(t){if("string"==typeof t)return a(t,e);var o=Object.prototype.toString.call(t).slice(8,-1);return"Object"===o&&t.constructor&&(o=t.constructor.name),"Map"===o||"Set"===o?Array.from(t):"Arguments"===o||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(o)?a(t,e):void 0}}function a(t,e){(null==e||e>t.length)&&(e=t.length);for(var o=0,n=new Array(e);o<e;o++)n[o]=t[o];return n}function r(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function _(t,e){for(var o=0;o<e.length;o++){var n=e[o];n.enumerable=n.enumerable||!1,n.configurable=!0,"value"in n&&(n.writable=!0),Object.defineProperty(t,n.key,n)}}function l(t,e,o){return e&&_(t.prototype,e),o&&_(t,o),t}var s=function(){function n(){r(this,n),this.elements={}}return l(n,[{key:"buildStyle",value:function(){return(0,t.el)("style","#cconsent-bar, #cconsent-bar * { box-sizing:border-box }","#cconsent-bar { background-color:"+window.CookieConsent.config.theme.barColor+"; color:"+window.CookieConsent.config.theme.barTextColor+"; padding:15px; text-align:right; font-family:sans-serif; font-size:14px; line-height:18px; position:fixed; bottom:0; left:0; width:100%; z-index:9998; transform: translateY(0); transition: transform .6s ease-in-out; transition-delay: .3s;}","#cconsent-bar.ccb--hidden {transform: translateY(100%); display:block;}","#cconsent-bar .ccb__wrapper { display:flex; flex-wrap:wrap; justify-content:space-between; max-width:1800px; margin:0 auto;}","#cconsent-bar .ccb__left { align-self:center; text-align:left; margin: 15px 0;}","#cconsent-bar .ccb__right { align-self:center; white-space: nowrap;}","#cconsent-bar .ccb__right > div {display:inline-block; color:#FFF;}","#cconsent-bar a { text-decoration:underline; color:"+window.CookieConsent.config.theme.barTextColor+"; }","#cconsent-bar button { line-height:normal; font-size:14px; border:none; padding:10px 10px; color:"+window.CookieConsent.config.theme.barMainButtonTextColor+"; background-color:"+window.CookieConsent.config.theme.barMainButtonColor+";}","#cconsent-bar a.ccb__edit { margin-right:15px }","#cconsent-bar a:hover, #cconsent-bar button:hover { cursor:pointer; }","#cconsent-modal { display:none; font-size:14px; line-height:18px; color:#666; width: 100vw; height: 100vh; position:fixed; left:0; top:0; right:0; bottom:0; font-family:sans-serif; font-size:14px; background-color:rgba(0,0,0,0.6); z-index:9999; align-items:center; justify-content:center;}","@media (max-width: 600px) { #cconsent-modal { height: 100% } }","#cconsent-modal h2, #cconsent-modal h3 {color:#333}","#cconsent-modal.ccm--visible {display:flex}","#cconsent-modal .ccm__content { max-width:600px; min-height:500px; max-height:600px; overflow-Y:auto; background-color:#EFEFEF; }","@media (max-width: 600px) { #cconsent-modal .ccm__content { max-width:100vw; height:100%; max-height:initial; }}","#cconsent-modal .ccm__content > .ccm__content__heading { border-bottom:1px solid #D8D8D8; padding:35px 35px 20px; background-color:#EFEFEF; position:relative;}","#cconsent-modal .ccm__content > .ccm__content__heading h2 { font-size:21px; font-weight:600; color:#333; margin:0 }","#cconsent-modal .ccm__content > .ccm__content__heading .ccm__cheading__close {font-weight:600; color:#888; cursor:pointer; font-size:26px; position: absolute; right:15px; top: 15px;}","#cconsent-modal h2, #cconsent-modal h3 {margin-top:0}","#cconsent-modal .ccm__content > .ccm__content__body { background-color:#FFF;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup {margin:0; border-bottom: 1px solid #D8D8D8; }",'#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup .ccm__tab-head::before { position:absolute; left:35px; font-size:1.4em; font-weight: 600; color:#E56385; content:"×"; display:inline-block; margin-right: 20px;}','#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup.checked-5jhk .ccm__tab-head::before {font-size:1em; content:"✔"; color:#28A834}',"#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup .ccm__tab-head .ccm__tab-head__icon-wedge { transition: transform .3s ease-out; transform-origin: 16px 6px 0; position:absolute;right:25px; top:50%; transform:rotate(0deg); transform:translateY(-50%)}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup .ccm__tab-head .ccm__tab-head__icon-wedge > svg { pointer-events: none; }","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup.ccm__tabgroup--open .ccm__tab-head .ccm__tab-head__icon-wedge {transform:rotate(-180deg)}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-head {color:#333; padding:17px 35px 17px 56px; margin:0}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content {padding:25px 35px; margin:0}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-head { transition: background-color .5s ease-out }","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-head:hover { background-color:#F9F9F9 }","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-head {font-weight:600; cursor:pointer; position:relative;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup .ccm__tab-content {display:none;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup.ccm__tabgroup--open .ccm__tab-head { background-color:#F9F9F9 }","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup.ccm__tabgroup--open .ccm__tab-content {display:flex;}","@media (max-width: 600px) { #cconsent-modal .ccm__content > .ccm__content__body .ccm__tabgroup.ccm__tabgroup--open .ccm__tab-content {flex-direction:column} }","@media (max-width: 600px) { #cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left { margin-bottom:20px; } }","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch-component {display:flex; margin-right:35px; align-items:center;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch-component > div {font-weight:600;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch-group {width:40px; height:20px; margin:0 10px; position:relative;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch {position: absolute; top:0; right:0; display: inline-block; width: 40px; height: 20px;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch input {display:none;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch .ccm__switch__slider  {position: absolute; cursor: pointer; top: 0; left: 0; right: 0; bottom: 0; background-color: #ccc; border-radius:10px; -webkit-transition: .4s; transition: .4s;}",'#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch .ccm__switch__slider:before  {position: absolute; content: ""; height: 12px; width: 12px; left: 4px; bottom: 4px; background-color: white; border-radius:50%; -webkit-transition: .4s; transition: .4s;}',"#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch input:checked + .ccm__switch__slider  {background-color: #28A834;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch input:focus + .ccm__switch__slider  {box-shadow: 0 0 1px #28A834;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__tab-content__left .ccm__switch input:checked + .ccm__switch__slider:before  {-webkit-transform: translateX(20px); -ms-transform: translateX(20px); transform: translateX(20px);}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content h3 {font-size:18px; margin-bottom:10px; line-height:1;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content p {color:#444; margin-bottom:0}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__list:not(:empty) {margin-top:0px;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__list .ccm__list__title {color:#333; font-weight:600;}","#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-content .ccm__list ul { margin:15px 0; padding-left:15px }","#cconsent-modal .ccm__footer { padding:35px; background-color:#EFEFEF; text-align:center; display: flex; align-items:center; justify-content:flex-end; }","#cconsent-modal .ccm__footer button { line-height:normal; font-size:14px; transition: background-color .5s ease-out; background-color:"+window.CookieConsent.config.theme.modalMainButtonColor+"; color:"+window.CookieConsent.config.theme.modalMainButtonTextColor+"; border:none; padding:13px; min-width:110px; border-radius: 2px; cursor:pointer; }","#cconsent-modal .ccm__footer button:hover { background-color:"+o.default.lightenDarkenColor(window.CookieConsent.config.theme.modalMainButtonColor,-20)+"; }","#cconsent-modal .ccm__footer button#ccm__footer__consent-modal-submit {  margin-right:10px; }")}},{key:"buildBar",value:function(){}},{key:"buildModal",value:function(){var o=function(o){var n=[];for(var c in window.CookieConsent.config.services)window.CookieConsent.config.services[c].category===o&&n.push(window.CookieConsent.config.services[c]);if(n.length){var i=[];return n.forEach(function(o){var n=e.default.getTranslation(o,window.CookieConsent.config.language.current,"name"),c=e.default.getTranslation(o,window.CookieConsent.config.language.current,"description"),a=e.default.getTranslation(o,window.CookieConsent.config.language.current,"duration"),r=(0,t.el)("div.row.ccm__list",(0,t.el)("span.col-3.ccm__list__title",(0,t.el)("h6","Name")),(0,t.el)("label.col-9",{title:c,"data-placement":"top","data-toggle":"tooltip"},n),(0,t.el)("span.col-3.ccm__list__title",(0,t.el)("h6","Description")),(0,t.el)("label.col-9",c),(0,t.el)("span.col-3.ccm__list__title",(0,t.el)("h6","Duration")),(0,t.el)("label.col-9",a));i.push(r)}),i}};return(0,t.el)("div#cconsent-modal",(0,t.el)("div.ccm__content",(0,t.el)("div.ccm__content__heading",(0,t.el)("h2",e.default.getTranslation(window.CookieConsent.config,window.CookieConsent.config.language.current,"modalMainTitle")),(0,t.el)("p",e.default.getTranslation(window.CookieConsent.config,window.CookieConsent.config.language.current,"modalMainText"),window.CookieConsent.config.modalMainTextMoreLink?(0,t.el)("a",{href:window.CookieConsent.config.modalMainTextMoreLink,target:"_blank",rel:"noopener noreferrer"},e.default.getTranslation(window.CookieConsent.config,window.CookieConsent.config.language.current,"modalMainTitle")):null),(0,t.el)("div.ccm__cheading__close","×")),(0,t.el)("div.ccm__content__body",(0,t.el)("div.ccm__tabs",function(){var n=[];for(var c in window.CookieConsent.config.categories)n.push((0,t.el)("dl.ccm__tabgroup."+c+(window.CookieConsent.config.categories[c].checked?".checked-5jhk":""),{"data-category":c},(0,t.el)("dt.ccm__tab-head",e.default.getTranslation(window.CookieConsent.config.categories[c],window.CookieConsent.config.language.current,"name"),(0,t.el)("a.ccm__tab-head__icon-wedge",(0,t.el)(document.createElementNS("http://www.w3.org/2000/svg","svg"),{version:"1.2",preserveAspectRatio:"none",viewBox:"0 0 24 24",class:"icon-wedge-svg","data-id":"e9b3c566e8c14cfea38af128759b91a3",style:"opacity: 1; mix-blend-mode: normal; fill: rgb(51, 51, 51); width: 32px; height: 32px;"},(0,t.el)(document.createElementNS("http://www.w3.org/2000/svg","path"),{"xmlns:default":"http://www.w3.org/2000/svg",id:"angle-down",d:"M17.2,9.84c0-0.09-0.04-0.18-0.1-0.24l-0.52-0.52c-0.13-0.13-0.33-0.14-0.47-0.01c0,0-0.01,0.01-0.01,0.01  l-4.1,4.1l-4.09-4.1C7.78,8.94,7.57,8.94,7.44,9.06c0,0-0.01,0.01-0.01,0.01L6.91,9.6c-0.13,0.13-0.14,0.33-0.01,0.47  c0,0,0.01,0.01,0.01,0.01l4.85,4.85c0.13,0.13,0.33,0.14,0.47,0.01c0,0,0.01-0.01,0.01-0.01l4.85-4.85c0.06-0.06,0.1-0.15,0.1-0.24  l0,0H17.2z",style:"fill: rgb(51, 51, 51);"})))),(0,t.el)("dd.ccm__tab-content",(0,t.el)("div.ccm__tab-content__left",!window.CookieConsent.config.categories[c].needed&&(0,t.el)("div.ccm__switch-component",(0,t.el)("div.status-off",e.default.getTranslation(window.CookieConsent.config,window.CookieConsent.config.language.current,"off")),(0,t.el)("div.ccm__switch-group",(0,t.el)("label.ccm__switch",(0,t.el)("input.category-onoff",{type:"checkbox","data-category":c,checked:window.CookieConsent.config.categories[c].checked}),(0,t.el)("span.ccm__switch__slider"))),(0,t.el)("div.status-on",e.default.getTranslation(window.CookieConsent.config,window.CookieConsent.config.language.current,"on")))),(0,t.el)("div.right",o(c)))));return n}())),(0,t.el)("div.ccm__footer",(0,t.el)("button#ccm__footer__consent-modal-submit",e.default.getTranslation(window.CookieConsent.config,window.CookieConsent.config.language.current,"modalBtnSave")),(0,t.el)("button.consent-give",e.default.getTranslation(window.CookieConsent.config,window.CookieConsent.config.language.current,"modalBtnAcceptAll")))))}},{key:"modalRedrawIcons",value:function(){var t,e=c(this.elements.modal.querySelectorAll(".ccm__tabgroup"));try{for(e.s();!(t=e.n()).done;){var o=t.value;window.CookieConsent.config.categories[o.dataset.category].checked?o.classList.contains("checked-5jhk")||(o.classList.add("checked-5jhk"),o.querySelector("input.category-onoff").checked=!0):(o.classList.contains("checked-5jhk")&&o.classList.remove("checked-5jhk"),o.querySelector("input.category-onoff").checked=!1)}}catch(n){e.e(n)}finally{e.f()}}},{key:"render",value:function(e,o,n){if(void 0===n&&(n=function(){}),void 0!==this.elements[e])return this.elements[e].parentNode.replaceChild(o,this.elements[e]),this.elements[e]=o,n(o),o;var c=(0,t.mount)(document.body,o);return c&&(this.elements[e]=c),n(c),c}},{key:"buildInterface",value:function(t){void 0===t&&(t=function(){});var e=this;o.default.ready(function(){e.render("style",e.buildStyle()),e.render("modal",e.buildModal()),t()})}},{key:"addEventListeners",value:function(t){var e,o=this,n=c(document.querySelectorAll(".consent-give"));try{for(n.s();!(e=n.n()).done;){e.value.addEventListener("click",function(){for(var t in window.CookieConsent.config.categories)window.CookieConsent.config.categories[t].wanted=window.CookieConsent.config.categories[t].checked=!0;o.writeBufferToDOM(),o.buildCookie(function(t){o.setCookie(t)}),o.elements.modal.classList.remove("ccm--visible"),o.modalRedrawIcons()})}}catch(r){n.e(r)}finally{n.f()}Array.prototype.forEach.call(document.getElementsByClassName("ccb__edit"),function(t){t.addEventListener("click",function(){o.elements.modal.classList.add("ccm--visible")})}),this.elements.modal.querySelector(".ccm__tabs").addEventListener("click",function(t){if(t.target.classList.contains("ccm__tab-head")||t.target.classList.contains("ccm__tab-head__icon-wedge")){var e=function t(e){var o=e.parentNode;return"DL"!==o.nodeName?t(o):o}(t.target);e.classList.contains("ccm__tabgroup--open")?e.classList.remove("ccm__tabgroup--open"):e.classList.add("ccm__tabgroup--open")}if(t.target.classList.contains("category-onoff")){window.CookieConsent.config.categories[t.target.dataset.category].wanted=window.CookieConsent.config.categories[t.target.dataset.category].checked=!0===t.target.checked;var o=document.querySelector(".ccm__tabgroup."+t.target.dataset.category);!1===t.target.checked&&o.classList.contains("checked-5jhk")?o.classList.remove("checked-5jhk"):o.classList.add("checked-5jhk")}}),this.elements.modal.querySelector(".ccm__cheading__close").addEventListener("click",function(t){o.elements.modal.classList.remove("ccm--visible")});var i,a=c(document.querySelectorAll("#ccm__footer__consent-modal-submit"));try{for(a.s();!(i=a.n()).done;){i.value.addEventListener("click",function(){var t=o.elements.modal.querySelectorAll(".ccm__switch input");Array.prototype.forEach.call(t,function(t){window.CookieConsent.config.categories[t.dataset.category].wanted=t.checked}),o.buildCookie(function(t){o.setCookie(t,function(){})}),o.elements.modal.classList.remove("ccm--visible"),o.writeBufferToDOM()})}}catch(r){a.e(r)}finally{a.f()}}},{key:"writeBufferToDOM",value:function(){var t,e=c(window.CookieConsent.buffer.appendChild);try{for(e.s();!(t=e.n()).done;){var o=t.value;!0===window.CookieConsent.config.categories[o.category].wanted&&Node.prototype.appendChild.apply(o.this,o.arguments)}}catch(r){e.e(r)}finally{e.f()}var n,i=c(window.CookieConsent.buffer.insertBefore);try{for(i.s();!(n=i.n()).done;){var a=n.value;!0===window.CookieConsent.config.categories[a.category].wanted&&(a.arguments[1]=null===a.arguments[0].parentNode?a.this.lastChild:a.arguments[1],Node.prototype.insertBefore.apply(a.this,a.arguments))}}catch(r){i.e(r)}finally{i.f()}}},{key:"buildCookie",value:function(t){var e={version:window.CookieConsent.config.cookieVersion,categories:{},services:[]};for(var n in window.CookieConsent.config.categories)e.categories[n]={wanted:window.CookieConsent.config.categories[n].wanted};return e.services=o.default.listGlobalServices(),t&&t(e),e}},{key:"setCookie",value:function(t,e){document.cookie="cconsent=".concat(JSON.stringify(t),"; expires=Thu, 01 Jan 2099 00:00:00 UTC; path=/;"),e&&e()}}]),n}();exports.default=s;
