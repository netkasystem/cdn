...
export default class Interface {
  ...
  buildStyle() {
    return el('style',
      ...
      '#cconsent-modal .ccm__content > .ccm__content__body .ccm__tab-head {font-weight:600; cursor:pointer; position:relative; float: none !important; width: 100% !important; text-transform: none !important;}',
