      ...
      var netkaCustom = function netkaCustom(category) {
        ...
        if (list.length) {
          ...
          list.forEach(function (item) {
            ...
            var ele = (0, _redom.el)('div.row.ccm__list', (0, _redom.el)('span.col-3.ccm__list__title', (0, _redom.el)('h6', 'Name')), (0, _redom.el)('label.col-9', {
              'title': cur_description,
              'data-placement': "top",
              'data-toggle': "tooltip"
            }, cur_name), (0, _redom.el)('span.col-3.ccm__list__title', (0, _redom.el)('h6', 'Description')), (0, _redom.el)('label.col-9', cur_description), (0, _redom.el)('span.col-3.ccm__list__title', (0, _redom.el)('h6', 'Duration')), (0, _redom.el)('label.col-9', cur_duration));
            listItems.push(ele);
          });
          return listItems;
        }
